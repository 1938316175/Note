...
public class EditJava extends EditText {
	...
	public EditJava(Context context) {
		this(context, null);
	}

	public EditJava(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public EditJava(Context context, AttributeSet attrs, int defStyle) {
